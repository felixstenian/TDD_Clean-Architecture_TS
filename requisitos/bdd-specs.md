...
```
  Como um cliente online:
    Qero que o sistema me mostre minhas compras
...
```
  Dado que o cliente tem conexão com a internet:
    ...
    Então o sistemas deve exibir suas compras vindo de uma API
    E susbstituir os dados do cache com os dados mais atuais
```
...
```
  Dado que o cliente não tem conexão com a internet:
    ...
    E os dado do cache forem mais novos que 3 dias
  - Quando o cliente solicitar para carregar suas compras
  - Então, o sistema deve exibir suas compras vindo do cache
